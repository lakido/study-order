...
public class MainScreenController implements Initializable {
    ...
    private ObservableList<RecipeModel> reicpeData = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        reicpeData.addAll(extractRecipeListOfFirstRecordsUseCase.invoke(10).getOrNull());
        ...
        startTableWithRecipes.setOnMouseClicked(mouseEvent -> {
            if (mouseEvent.getClickCount() == 2) {
                handleDoubleClickToCreateWindowWithIngredients();
            }
        });
    }

    public TableView<RecipeModel> getStartTableWithRecipes() {
        return startTableWithRecipes;
    }

    public TableColumn<RecipeModel, String> getName() {
        return recipeNameColumn;
    }

    public TableColumn<RecipeModel, String> getCategory() {
        return recipeCategoryColumn;
    }

    public TableColumn<RecipeModel, Integer> getPopularity() {
        return recipePopularityColumn;
    }

    public TableColumn<RecipeModel, Integer> getAge_preferences() {
        return recipeAgePreferencesColumn;
    }
    ...
    private void handleDoubleClickToCreateWindowWithIngredients() {
        Stage stage = new Stage();
    ...
    private void createAndCustomizeTableView() {
        ...
        startTableWithRecipes.widthProperty().addListener(((observableValue, oldValue, newValue) -> {
            double tableWidth = newValue.doubleValue();

            recipeNameColumn.setPrefWidth(tableWidth * 0.2);
            recipeCategoryColumn.setPrefWidth(tableWidth * 0.3);
            recipePopularityColumn.setPrefWidth(tableWidth * 0.2);
            recipeAgePreferencesColumn.setPrefWidth(tableWidth * 0.3);
        } ));
        ...
        startTableWithRecipes.setItems(reicpeData);
    }
}
